  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-6xl mx-auto px-6 py-8 space-y-6">
      ...
      <Card
        ...
        class="p-0 border-blue-100 bg-blue-50/60"
      >
        <CardContent class="px-4 py-3 flex items-center justify-between gap-3">
          <div class="flex items-center gap-2.5">
            <ShieldCheck class="size-4 text-blue-700 shrink-0" />
            <p class="text-sm text-blue-800">
              Kamu juga terdaftar sebagai staff lab. Mau kelola lab, bukan booking pribadi?
            </p>
          </div>
          <RouterLink
            :to="authStore.hasRole('super_admin') ? '/admin' : '/dashboard'"
            class="text-sm font-medium text-blue-700 hover:underline whitespace-nowrap flex items-center gap-1 shrink-0"
          >
            Ke Dashboard Admin
      ...
      <div>
        ...
        <p class="text-gray-500 text-sm mt-0.5">Ini ringkasan aktivitas booking kamu.</p>
      </div>
