...
<button
  type="button"
  title="Lihat penuh"
  class="absolute top-2 left-2 p-1.5 rounded-md bg-white/90 text-gray-500 hover:text-gray-900 shadow opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity z-10"
...
<button
  ...
  type="button"
  title="Hapus foto"
  class="absolute p-1.5 rounded-md bg-white/90 text-gray-500 hover:text-red-600 shadow opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity z-10"
